...
Summary: Type annotations for AWS awscrt 0.36.2 library
...
pixi add types-awscrt
# for installing globally
pixi global install types-awscrt
```
...
It is possible to list all of the versions of `types-awscrt` available on your platform:
...
```
pixi search types-awscrt --channel conda-forge
```
